...
- [x] **Task 1.1: State Machine Enums & Exception**
...
- [x] **Task 1.2: State Machine Validator Tests (TDD - Red Phase)**
...
- [x] **Task 1.3: State Machine Validator Implementation (TDD - Green Phase)**
    - Implement `TicketStateTransitionValidator` component.
    - Run tests and confirm 100% pass rate.

## Phase 2: Persistence Layer
- [x] **Task 2.1: Entities & Repositories**
...
- [x] **Task 4.1: Global Exception Handler**
